<div class="bg-first px-3 py-4 d-flex flex-column gap-4" id="side">
    ...
    <div class="container-fluid m-0 px-3 py-2 bg-white link">
        <a href="<?= base_url('dashboard') ?>" class="lead text-decoration-none m-0 font-bold text-first d-flex gap-3 align-items-center">
            <img src="<?= base_url('assets/img/dashboard.png') ?>" alt=""> 
            <small>Dashboard</small>
        </a>
    </div>
    
    <div class="container-fluid m-0 px-3 py-2 link dropdown">
        <a data-bs-toggle="collapse" href="#collapseExample" role="button"
            class="lead text-decoration-none m-0 font-bold text-white d-flex gap-3 align-items-center">
            <img src="<?= base_url('assets/img/user-white.png') ?>" alt=""> 
        ...
        <div class="collapse" id="collapseExample">
            ...
            <div class="d-flex flex-column gap-3 align-items-center py-3">
                ...
                <a href="<?= base_url('customer') ?>" class="text-decoration-none text-fourth">ID Customer</a>
            </div>
        </div>
    </div>
