...
<body>
    ...
    <div class="collapse" id="collapseExample">
        ...
        <div class="d-flex flex-column gap-3 align-items-center py-3">
            <a href="<?= base_url('pengiriman') ?>" class="text-decoration-none text-first">Pengiriman</a>
            <a href="<?= base_url('id-customer') ?>" class="text-decoration-none text-fourth">ID Customer</a>
        </div>
    </div>
</div>
            <div class="container-fluid m-0 px-3 py-2 link">
                ...
                <div class="modal-content">
                    <div class="modal-body text-center py-4">
                        ...
                        <div class="gap-2 col-6 mx-auto mt-3">
                            <a href="<?= base_url('logout') ?>" type="button" class="btn btn-modal-custom">Ya</a>
        ...
        <div class="d-flex flex-column" id="main">
            <div class="container-fluid bg-first py-3 px-4 d-flex justify-content-between align-items-center shadow-lg"
                ...
                <div class="right d-flex align-items-center gap-3">
                    <h6 class="text-white m-0 font-bold"><?= session()->get('username') ?></h6>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if (dropdownLink) {
                dropdownLink.addEventListener('click', e => {
                    const isCollapse = !dropdownLink.classList.contains('collapsed');
                    const dropdown = document.querySelector('.dropdown');
                    const img = dropdownLink.querySelector('img');
                    
                    if (isCollapse) {
                        dropdown.classList.add('bg-white');
                        dropdownLink.classList.add('text-first');
                        img.src = "<?= base_url('assets/img/user-blue.png') ?>";
                    } else {
                        dropdown.classList.remove('bg-white');
                        dropdownLink.classList.remove('text-first');
                        img.src = "<?= base_url('assets/img/user-white.png') ?>";
                    }
                });
            }
        });
